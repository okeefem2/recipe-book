...
export class RecipeEditComponent implements OnInit {
  id: number;
  editMode = false; // false means new mode
  ...
  onSubmit() {
    ...
    // )
    // if you make sure to make the fields names and types the same as the model
    // that that the function is accepting, you can just accept the value!
    if (this.editMode) {
